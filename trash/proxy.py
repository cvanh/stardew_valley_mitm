...
import trash.parser_part10 as parser
...
master_server = Proxy('0.0.0.0', '192.168.178.54', 40743)
master_server.start()

# game_servers = []
# # for port in range(24642):
_game_server = Proxy('0.0.0.0', '192.168.178.54', 40743)
_game_server.start()
